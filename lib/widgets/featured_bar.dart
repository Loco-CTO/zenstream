  ...
  List<Widget> _buildPageViewChildren() {
    return [
      _buildPageViewItem(
        ...
        'http://https://theatre.lococto.me:8096/Items/da676de3fefca05971961fcb7ac4584a/Images/Backdrop/0?tag=6a3bbf7c2a38bccc8076cac288f1a18d',
      ),
      _buildPageViewItem(
...
月に存在するあらゆる願いを叶える力を持った霊子コンピュータ「ムーンセル・オートマトン」。ムーンセル内につくられた霊子虚構世界「SE.RA.PH」。"聖杯"をかけた、 魔術師 ウィザードと 英霊 サーヴァントによる、新たな月の聖杯戦争、開演。''',
        'http://https://theatre.lococto.me:8096/Items/0f1acb07c7dd5b6664a9108885f30160/Images/Backdrop/0?tag=614d4bf84e20306cef8510772c7cd48e',
      ),
      _buildPageViewItem(
        'コードギアス 反逆のルルーシュ',
        '他人を支配する不思議な力を与えられた後、追放された王子は、すべての強力な帝国に対する反乱の覆面をしたリーダーになります',
        'http://https://theatre.lococto.me:8096/Items/329e09da86188f42c1f304be2a60946a/Images/Backdrop/0?tag=4a2ee96169101034d153c45e5fc97c88',
      ),
      _buildPageViewItem(
        '陰の実力者になりたくて!',
        ...
        'http://https://theatre.lococto.me:8096/Items/3f8de89d877357e6e3921837ec2cb4eb/Images/Backdrop/0?tag=92e53a98106bebf5dc28c52c239c5919',
      ),
      _buildPageViewItem(
        'ようこそ実力至上主義の教室へ',
        ...
        'http://https://theatre.lococto.me:8096/Items/0b9f7abd2dd49aa0f950dbe0c73dfa88/Images/Backdrop/0?tag=ccc8b33c5e893923c347f6eaad40df2b',
      ),
    ];
  }
