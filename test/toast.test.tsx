...
function Triggers() {
	...
	return <><button onClick={() => toast.success("Joined the group")}>Success</button><button onClick={() => toast.error("Could not join")}>Error</button></>;
}
...
describe("ToastProvider", () => {
	...
	it("stacks accessible toasts that can be dismissed or expire", () => {
		vi.useFakeTimers();
		render(<I18nProvider locale="en"><ToastProvider><Triggers /></ToastProvider></I18nProvider>);
